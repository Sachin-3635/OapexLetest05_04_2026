...
export default function OpexDashboard(props: IOpexDashboardProps) {
  ...
  // };
  const navigate = (pageName: string) => {
    const url = `${props.context.pageContext.web.absoluteUrl}/SitePages/OpexAdvancedForm.aspx?page=${pageName}`;
    window.history.pushState({}, "", url);
    setPage(pageName);
  };
    ...
    <div>
      ...
      {page === "home" && (
        <div className="main-container">
          <div className="headSheet"><h2>Opex Advance form</h2></div>
